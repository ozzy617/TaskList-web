...
public class UserDto {
    ...
    @Schema(description = "User crypted password", example = "$2a$10$1Y1nI9l6GUxtD8wIRhd.dO26jnWXoGYfl8TJkRYqvAj6khKfDZ8dq")
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
    @NotNull(message = "Password must be not null.", groups = {OnUpdate.class, OnCreate.class})
    private String password;

    @Schema(description = "User password confirmation", example = "$2a$10$1Y1nI9l6GUxtD8wIRhd.dO26jnWXoGYfl8TJkRYqvAj6khKfDZ8dq")
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
